...
/* Requête principale */
$query = $connect->query("SELECT ID, Reference, Debut_Reservation, Fin_Reservation, Arrivee, Depart, Place_ID, Client_ID FROM reservation WHERE Reference = '" . $_GET["Reference"] . "'");
